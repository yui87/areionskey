<template>
<x-draggable tag="div" :list="blocks" handle=".drag-handle" :group="{ name: 'blocks' }" animation="150" swapThreshold="0.5">
	<component :is="'x-' + block.type" v-for="block in blocks" :key="block.id" :value="block" :aiScript="aiScript" @input="updateItem" @remove="() => removeItem(block)"/>
</x-draggable>
</template>
