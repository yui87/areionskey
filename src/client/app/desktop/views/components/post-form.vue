...
<div>
	...
	>
		<div class="content">
			...
			<div class="textarea">
				<textarea ref="text" v-model="text" v-autocomplete="{ model: 'text' }" :class="{ with: (files.length != 0 || poll) }" :disabled="posting" :placeholder="placeholder" @keydown="onKeydown" @paste="onPaste"></textarea>
