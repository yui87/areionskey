...
虐待的、嫌がらせ、またはその他の許容できない行動の事例は、執行を担当するコミュニティリーダーに対して sakura-tel@pm.me で報告される場合があります。
...
この行動規範は、[https://www.contributor-covenant.org/ja/version/2/0/code_of_conduct/][v2.0ja] で利用可能な [Contributor Covenant][homepage] バージョン2.0 を基に作成されています。

コミュニティへの影響ガイドラインは [Mozilla's code of conduct enforcement ladder][Mozilla CoC] に適合しています。

[homepage]: https://www.contributor-covenant.org
[v2.0ja]: https://www.contributor-covenant.org/ja/version/2/0/code_of_conduct/
